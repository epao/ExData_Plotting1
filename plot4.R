################################################################################
# AUTHOR: Eric Pao
# TITLE: Exploratory Data Analysis - Week 1 - Plot 4
# DATE: 01/03/2017
################################################################################
...
subset_raw$Voltage <- as.numeric(subset_raw$Voltage)
subset_raw$Global_active_power <- as.numeric(subset_raw$Global_active_power)
subset_raw$Global_reactive_power <- as.numeric(subset_raw$Global_reactive_power)
...
par(mfrow = c(2,2))
plot(subset_raw$dateTime,subset_raw$Global_active_power,type="l",ylab="Global Active Power",xlab="",col="black")
plot(subset_raw$dateTime,subset_raw$Voltage,type="l",ylab="Voltage",xlab="datetime",col="black")
...
plot(subset_raw$dateTime,subset_raw$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power",col="black")
dev.off()
